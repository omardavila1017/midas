...
import { BASE_SCENARIO_ID, FlowPlan, Proposal, Scenario, ScenarioCellOverride, Simulation, TabId, ForecastView } from './types';
            ...
            {activeTab === 'scenarios' && (
              plan
                ? <ScenarioWorkbench
                  ...
                  />
                : <PlanRequired onUpload={() => setShowUpload(true)} feature="Escenarios" />
            )}
            {activeTab === 'cxp' && (
              <CXP
                records={cxpRecords}
