...
function mapCobranza(raw: RawRecord): CobranzaRecord {
  ...
  const diaPagoClave = toStr(pick(raw, ['diaPagoClave', 'clave_dia_pago_cc13', 'Clave_Dia_Pago_CC13'])) || undefined;
  const diaPagoNombre = toStr(pick(raw, ['diaPagoNombre', 'nombre_dia_pago_cc13', 'Nombre_Dia_Pago_CC13'])) || undefined;
