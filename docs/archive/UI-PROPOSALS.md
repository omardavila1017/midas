...
> 📦 **Archived — historical snapshot (Apr 20, 2026), NOT current.** Many proposals here are already implemented (Command Palette, Toasts, Keyboard shortcuts, Activity feed, Dark mode, etc.). Kept for provenance. Current state: `CLAUDE.md` / `README.md`.
