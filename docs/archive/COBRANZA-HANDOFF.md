...
> 📦 **Archivado — snapshot histórico (3 may 2026), NO es el estado actual.** Los bugs P0/P1 que describe (crashes, cruce en 0%) ya se resolvieron (workers, IndexedDB, perf hardening, AuxiliarContable). Conservado por trazabilidad. Para el estado actual lee `CLAUDE.md` y `README.md`; ver `docs/archive/README.md`.
...
El browser debe llamar a `/api/jde`; el proxy de Vite local o el backend inyectan el Bearer fuera del bundle.
