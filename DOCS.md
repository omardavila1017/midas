...
| `docs/AUDITORIA-CONEXIONES-APIS-2026-07.md` | Auditoría del sistema de conexiones (2026-07-10): estado real de cada API vs el mapa de negocio, huecos y seguimiento. Complementa `docs/MAPA-CONEXIONES-APIS.md`. | Devs / integración |
| `docs/PENDIENTES-ORIGEN-JDE.md` | Pendientes que NO son de Midas (medidos 2026-09-21): las cuatro tablas espejo que no truncan antes de insertar, `db_Artefactos` sin `BACKUP LOG`, calidad de captura y las peticiones de API abiertas. Cada punto con qué pedir y cómo verificar que quedó. Para escalar al equipo de JDE/BD. | JDE / BD / integración |
| `PLAUD-CLAUDE-CODE-LOG.md` | Bitácora de continuidad Plaud→Claude Code (qué corrida hizo qué, fuente de verdad entre sesiones). | Devs / agents |
